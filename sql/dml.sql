...
VALUES (
        ...
        'https://storage.googleapis.com/blog_img/image-01.webp',
        NOW(),
        (
            SELECT id
            FROM teacher
...
VALUES (
        ...
        'https://storage.googleapis.com/blog_img/image-02.webp',
        NOW(),
        (
            SELECT id
            FROM teacher
...
VALUES (
        ...
        'https://storage.googleapis.com/blog_img/image-03.webp',
        NOW(),
        (
            SELECT id
            FROM teacher
...
VALUES (
        ...
        'https://storage.googleapis.com/blog_img/image-04.webp',
        NOW(),
        (
            SELECT id
            FROM teacher
