...
-- Posts para o professor John Smith (Programação em Java)
...
-- Posts para o professor Jane Doe (Desenvolvimento Web)
INSERT INTO post (title, content, urlImage, createdAt, teacher_id) VALUES 
...
-- Posts para o professor Emily Davis (Python)
INSERT INTO post (title, content, urlImage, createdAt, teacher_id) VALUES 
...
-- Posts para o professor Michael Brown (Programação Orientada a Objetos)
INSERT INTO post (title, content, urlImage, createdAt, teacher_id) VALUES 
...
-- Posts para a professora Sarah White (Desenvolvimento Mobile)
INSERT INTO post (title, content, urlImage, createdAt, teacher_id) VALUES 
...
-- Posts para o professor John Smith (Desenvolvimento Backend)
INSERT INTO post (title, content, urlImage, createdAt, teacher_id) VALUES 
...
-- Posts para o professor Jane Doe (JavaScript Avançado)
INSERT INTO post (title, content, urlImage, createdAt, teacher_id) VALUES 
...
-- Posts para o professor Emily Davis (Data Science com Python)
INSERT INTO post (title, content, urlImage, createdAt, teacher_id) VALUES 
...
-- Posts para o professor Michael Brown (Inteligência Artificial)
INSERT INTO post (title, content, urlImage, createdAt, teacher_id) VALUES 
...
-- Posts para a professora Sarah White (DevOps)
INSERT INTO post (title, content, urlImage, createdAt, teacher_id) VALUES 
